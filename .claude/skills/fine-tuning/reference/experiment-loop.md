...
experiment_loop:
  ...
  trainer_type: "sft"             # "sft", "kto", or "grpo"
  eval_backend: "local"           # "local" or "cloud"
  search_strategy: "llm_surrogate" # "llm_surrogate", "random", "grid"
...
- LightGBM surrogate requires `pip install lightgbm` (optional dependency — 2 tests skip without it)
