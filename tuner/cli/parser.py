...
"""
    ...
    parser.add_argument("--train-evolutionary-strategy", choices=["gradient_noise", "scale_variation", "combined"], help="Override evolutionary candidate generation strategy for cloud/cloud-pipeline SFT training.")
